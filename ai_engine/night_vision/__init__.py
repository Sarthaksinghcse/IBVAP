...
__all__ = [
    ...
    "MODE_OFF", "MODE_AUTO", "MODE_ALWAYS", "VALID_MODES",
    "PROFILE_DAY", "PROFILE_DUSK", "PROFILE_NIGHT", "PROFILE_EXTREME_LOW", "PROFILE_ORDER",
    "get_enhancer", "get_runtime_config", "update_runtime_config", "reset_runtime_config",
]
...
def reset_runtime_config() -> NightVisionConfig:
    """Reset the runtime config back to default tuned parameters."""
    global _runtime_config
    _runtime_config = NightVisionConfig()
    return _runtime_config
